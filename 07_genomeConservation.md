...
![enDistribution](resources/enDistribution.png)

We also calculated some basic summary statistics for distances from peaks to TSS, which revealed that a sizable portion of peaks located ≥ 10 Kb from the nearest TSS.

```R
#basic stats on conserved distal peaks
> summary(abs(enAnnot.ATAC$distance))
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    103    1062    2881    7450    9314   91174 
